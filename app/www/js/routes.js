...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('bemVindoAoAPP',      		   {url: '/home',			 templateUrl: 'templates/inicio/bemVindoAoAPP.html',			  controller: 'bemVindoAoAPPCtrl', 				controllerAs: 'vm'})
  .state('selecioneOSeuPapel',		   {url: '/selecione',		 templateUrl: 'templates/inicio/selecioneOSeuPapel.html',		  controller: 'selecioneOSeuPapelCtrl', 		controllerAs: 'vm'})
  .state('cadastroDeSindico',  		   {url: '/cadSindico',		 templateUrl: 'templates/inicio/cadastroDeSindico.html',		  controller: 'cadastroDeSindicoCtrl', 			controllerAs: 'vm'})
  .state('cadastroRecepcao',		   {url: '/cadRecepcao',	 templateUrl: 'templates/inicio/cadastroRecepcao.html',			  controller: 'cadastroRecepcaoCtrl', 			controllerAs: 'vm'})
  .state('cadastroEfetuadoComSucesso', {url: '/sucessoRecepcao', templateUrl: 'templates/inicio/cadastroEfetuadoComSucesso.html', controller: 'cadastroEfetuadoComSucessoCtrl', controllerAs: 'vm'});
  ...
  .state('cadastroDeDependentes',           { url: '/cadDependentes',   templateUrl: 'templates/cadastroDeDependentes.html',  controller: 'cadastroDeDependentesCtrl',  controllerAs: 'vm' })
  .state('alteraDependentes',               { url: '/alteraDependente', templateUrl: 'templates/alteraDependentes.html',      controller: 'alteraDependentesCtrl',      controllerAs: 'vm' })
  .state('dependentesCadastrados',          { url: '/page12',           templateUrl: 'templates/dependentesCadastrados.html', controller: 'dependentesCadastradosCtrl', controllerAs: 'vm' })
  .state('cadastroDeInquilino',             { url: '/cadInquilino',     templateUrl: 'templates/cadastroDeInquilino.html',    controller: 'cadastroDeInquilinoCtrl',    controllerAs: 'vm' })
  .state('cadastrarCondominio',             { url: '/cadCondominio',    templateUrl: 'templates/cadastrarCondominio.html',    controller: 'cadastrarCondominioCtrl',    controllerAs: 'vm' })
  .state('infoConvite',                     { url: '/infoConvite',      templateUrl: 'templates/infoConvite.html',            controller: 'infoConviteCtrl',            controllerAs: 'vm' })
